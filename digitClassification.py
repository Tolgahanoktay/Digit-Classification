...
#sondaki 1 tamamen keras boyle bir yapi istedigi ve kabul ettigi icin
x_train = x_train.reshape(x_train.shape[0],img_rows,img_cols,1)
x_test = x_test.reshape(x_test.shape[0],img_rows,img_cols,1)
input_shape = (img_rows,img_cols,1)

#normalization
"""siyah renklerin uzerinde gezildiginde 0 degeri beyaz renkte 1 degeri goruruz bir resmin
 ya da rengin alabilicegi max renk rgb'si 255 eger biz o ve 1 lerden olusan matrisleri 255e
 bolersek bunlari renkleri 0 ve 1 den olusan bir matrise sikistirabiliriz"""
